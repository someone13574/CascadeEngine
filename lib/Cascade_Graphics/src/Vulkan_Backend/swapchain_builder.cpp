...
namespace Cascade_Graphics
{
    namespace Vulkan
    {
        Swapchain_Builder::Swapchain_Builder(Physical_Device* physical_device_ptr, Surface* surface_ptr) : m_physical_device_ptr(physical_device_ptr), m_surface_ptr(surface_ptr)
        {
