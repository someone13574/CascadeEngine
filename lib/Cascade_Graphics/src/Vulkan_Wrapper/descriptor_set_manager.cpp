...
namespace Cascade_Graphics
{
    namespace Vulkan_Backend
    {
        ...
        {
            LOG_INFO << "Vulkan Backend: Creating descriptor set layout for '" << label << "'";
        ...
        {
            LOG_INFO << "Vulkan Backend: Creating descriptor pool for '" << label << "'";
        ...
        {
            LOG_INFO << "Vulkan Backend: Allocating descriptor set for '" << label << "'";
        ...
        {
            LOG_INFO << "Vulkan Backend: Creating write descriptor set for '" << label << "'";
        ...
        void Descriptor_Set_Manager::Remove_Descriptor_Set(std::string resource_grouping_label)
        {
            ...
            LOG_ERROR << "Vulkan Backend: The descriptor set '" << resource_grouping_label << "' does not exist";
            exit(EXIT_FAILURE);
        }
        ...
        Descriptor_Set_Manager::Descriptor_Set_Data* Descriptor_Set_Manager::Get_Descriptor_Set_Data(std::string label)
        {
            ...
            LOG_ERROR << "Vulkan Backend: The descriptor set '" << label << "' does not exist";
            exit(EXIT_FAILURE);
        }
    } // namespace Vulkan_Backend
} // namespace Cascade_Graphics