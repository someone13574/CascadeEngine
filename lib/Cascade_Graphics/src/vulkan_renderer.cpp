...
namespace Cascade_Graphics
{
    Vulkan_Renderer::Vulkan_Renderer(Graphics* graphics_ptr, Platform platform, Window_Info* window_info_ptr)
    {
        ...
        std::vector<Vulkan::Descriptor> rendering_descriptors = {Vulkan::Descriptor(m_camera_buffer_ptr, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER)};
        m_rendering_descriptor_set_ptr = new Vulkan::Descriptor_Set(vulkan_graphics_ptr->m_device_ptr, rendering_descriptors);
        std::vector<Vulkan::Descriptor_Set*> rendering_descriptor_sets = {m_rendering_descriptor_set_ptr};

        m_rendering_pipeline_ptr = new Vulkan::Compute_Pipeline(vulkan_graphics_ptr->m_device_ptr, "../lib/Cascade_Graphics/src/Vulkan_Backend/Shaders/render.comp", rendering_descriptor_sets);
    ...
    Vulkan_Renderer::~Vulkan_Renderer()
    {
        ...
        delete m_rendering_descriptor_set_ptr;
