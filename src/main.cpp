...
int main()
{
    ...
    main_window_ptr->Get_Renderer()->m_object_manager_ptr->Create_Object_From_Volume_Function("test", 11, Cascade_Graphics::Vector_3<double>(0, 0, 0), 2.0, Volume_Sample_Function, Color_Sample_Function);
